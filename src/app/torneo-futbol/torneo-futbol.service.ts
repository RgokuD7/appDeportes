...
const apiUrl = "http://localhost:3000/torneos";
...
export class TorneoFutbolService {
  ...
  addTorneo(torneo: ClToreno_futbol): Observable<ClToreno_futbol> {
    ...
    return this.http.post<ClToreno_futbol>(apiUrl, torneo, httpOptions)
      .pipe(  // Tubería
  ...
  getTorneos(): Observable<ClToreno_futbol[]> {
    ...
    return this.http.get<ClToreno_futbol[]>(apiUrl)
      .pipe(
  ...
  getTorneo(id: String): Observable<ClToreno_futbol> {
    ...
    return this.http.get<ClToreno_futbol>(apiUrl + "/" + id)
      .pipe(
  ...
  deleteTorneo(id: number): Observable<ClToreno_futbol> {
    ...
    return this.http.delete<ClToreno_futbol>(apiUrl + "/" + id, httpOptions)
      .pipe(
  ...
  updateTorneo(id: number, torneo: ClToreno_futbol): Observable<ClToreno_futbol> {
    return this.http.put<ClToreno_futbol>(apiUrl + "/" + id, torneo, httpOptions)
      .pipe(
